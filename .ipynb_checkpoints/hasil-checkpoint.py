...
image_path = 'dataset/test/on_time/2018230060.jpg'  # Ganti dengan path gambar uji Anda
...
class_names = ['not_on_time', 'on_time']  # Sesuaikan dengan urutan kelas yang digunakan saat melatih
